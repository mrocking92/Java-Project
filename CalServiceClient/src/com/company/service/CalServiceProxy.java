...
public class CalServiceProxy implements com.company.service.CalService {
  private String _endpoint = null;
  private com.company.service.CalService calService = null;
  ...
  private void _initCalServiceProxy() {
    try {
      calService = (new com.company.service.CalServiceServiceLocator()).getCalService();
      if (calService != null) {
        if (_endpoint != null)
  ...
  public com.company.service.CalService getCalService() {
    if (calService == null)
      _initCalServiceProxy();
    return calService;
  }
