...
public class CalServiceServiceLocator extends org.apache.axis.client.Service implements com.company.service.CalServiceService {
    ...
    public com.company.service.CalService getCalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.company.service.CalServiceSoapBindingStub _stub = new com.company.service.CalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.company.service.CalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.company.service.CalServiceSoapBindingStub _stub = new com.company.service.CalServiceSoapBindingStub(new java.net.URL(CalService_address), this);
                _stub.setPortName(getCalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.company.com", "CalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.company.com", "CalService"));
        }
